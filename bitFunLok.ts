...
namespace bitFunLok {
    ...
    export function getPainoStatus():number {
        let foil2 = ((pins.digitalReadPin(DigitalPin.P2) == PulseValue.High) ? (1) : (0));
        let foil1 = ((pins.digitalReadPin(DigitalPin.P8) == PulseValue.High) ? (1) : (0));
        let foil0 = ((pins.digitalReadPin(DigitalPin.P1) == PulseValue.High) ? (1) : (0));
